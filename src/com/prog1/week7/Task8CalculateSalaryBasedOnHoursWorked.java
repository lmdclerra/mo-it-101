...
/*
Task 8: Calculate Salary Based on Hours Worked

1. 	Update your code to calculate an employee’s one-week salary based on the number of hours worked.
2. 	Use the sample data found in MotorPH’s employee database to test your code.
3.  Refer to your use case diagrams to structure how data will be displayed in your Netbeans console.
4.  Add comments as necessary and practice unit testing.
*/
public class Task8CalculateSalaryBasedOnHoursWorked {
